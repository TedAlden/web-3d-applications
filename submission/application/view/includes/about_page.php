...
<a class="btn btn-primary btn-responsive" href="apigetdatatable">Show database contents as HTML table</a>
<br>
<a class="btn btn-primary btn-responsive" href="apigetdatajson">Show database contents as JSON</a>